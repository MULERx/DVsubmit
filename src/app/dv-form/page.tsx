        ...
        <div className="max-w-4xl mx-auto px-6 py-3">
          <div className="flex items-center gap-3">
            ...
            <div className="text-sm text-yellow-800">
              <span className="font-semibold text-sm">Important:</span> This is
              not a government service. You can submit applications for multiple
              eligible family members. Each application requires a separate 399
              ETB service fee (non-refundable after submission).
            </div>
          </div>
        </div>
      </div>
