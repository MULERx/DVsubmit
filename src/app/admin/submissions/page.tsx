          ...
          applications.map((app) =>
            app.id === selectedApp.id
              ? {
                  ...
                  status: updateStatus,
                  confirmationNumber:
                    confirmationNumber.trim() || app.confirmationNumber,
                  submittedAt:
                    updateStatus === "CONFIRMED" && !app.submittedAt
        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900">
              Official DV Submission
            </h2>
            <p className="mt-1 text-sm text-gray-600">
              Submit verified applications to the official U.S. DV lottery
              system and track confirmation numbers.
            </p>
          </div>
            ...
            <div className="mt-3">
              ...
              <div className="mt-4">
                <p className="text-sm text-gray-600">
                  <strong>User:</strong> {selectedApp.firstName}{" "}
            ...
            <div className="mt-3">
              ...
              <div className="mt-4">
                ...
                {selectedApp.confirmationNumber && (
                  <p className="text-sm text-gray-600">
                    <strong>Current Confirmation:</strong>{" "}
                    <span className="font-mono">
                      {selectedApp.confirmationNumber}
                    </span>
                  </p>
              ...
              <div className="mt-4">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setUpdateStatus(
                      e.target.value as "SUBMITTED" | "CONFIRMED" | "FAILED"
                    )
                  }
                  className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                >
              ...
              <div className="mt-4">
                <label
                  htmlFor="updateConfirmationNumber"
                  className="block text-sm font-medium text-gray-700"
                >
                  Confirmation Number
                </label>
