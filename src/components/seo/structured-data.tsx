...
export const organizationStructuredData = {
  name: "DVSubmit",
  description:
    "Professional DV Lottery assistance service providing expert help with Diversity Visa applications",
...
export const serviceStructuredData = {
  ...
  description:
    "Professional assistance with Diversity Visa lottery applications including form completion, photo validation, and secure submission",
  provider: {
    "@type": "Organization",
    name: "DVSubmit",
  },
