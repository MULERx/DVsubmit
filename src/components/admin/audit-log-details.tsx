                        ...
                        <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-2">
                              <code className="text-sm font-mono text-gray-900">{auditLog.id}</code>
                              <button
                            ...
                            <div className="space-y-3">
                              <div className="flex items-center space-x-3">
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="flex items-center space-x-2">
                                    <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${getRoleColor(auditLog.user.role)}`}>
                        ...
                        <div>
                          ...
                          <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                            <div className="flex items-center space-x-3">
                              ...
                              <div className="flex-1">
                                <div className="text-sm font-medium text-gray-900">
                                  {auditLog.application.familyName}, {auditLog.application.givenName}
                                </div>
                              ...
                              <button
                                onClick={() => copyToClipboard(auditLog.application!.id)}
                                className="text-gray-400 hover:text-gray-600"
                              >
                                <Copy className="h-4 w-4" />
                              </button>
                        ...
                        <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <span className="text-sm text-gray-900">{userAgentInfo.browser}</span>
                            </div>
                          </div>
                          
                          <div className="flex items-center justify-between">
                            <span className="text-sm text-gray-500">Operating System:</span>
                            <span className="text-sm text-gray-900">{userAgentInfo.os}</span>
                          </div>
                          
                          {auditLog.userAgent && (
                            <div>
                              <div className="flex items-center justify-between mb-2">
                                <span className="text-sm text-gray-500">Full User Agent:</span>
                                <button
