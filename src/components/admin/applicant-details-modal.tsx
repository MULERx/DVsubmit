...
export function ApplicantDetailsModal({ applicant, open, onOpenChange }: ApplicantDetailsModalProps) {
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          {/* Applicant Info */}
              ...
              {/* Applications */}
              <div>
                <h4 className="text-sm font-medium text-gray-900 mb-4">Applications</h4>
