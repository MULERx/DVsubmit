...
export class PaymentService {
   ...
   */
  static async submitPaymentReference(
    ...
    try {
      ...
      return {
        ...
        error: {
          code: "NETWORK_ERROR",
          message:
            "Failed to submit payment reference. Please check your connection.",
        },
      };
    }
  }
    ...
    try {
      ...
      return {
        ...
        error: {
          code: "NETWORK_ERROR",
          message:
            "Failed to fetch payment status. Please check your connection.",
        },
      };
    }
  }
   ...
   */
  static async getPaymentStatusById(
   ...
   */
  static getPaymentStatusMessage(
    status:
      | "PAYMENT_PENDING"
      | "PAYMENT_VERIFIED"
      | "PAYMENT_REJECTED"
    ...
    switch (status) {
      case "PAYMENT_VERIFIED":
        return {
          ...
          description:
            "Your payment has been verified successfully. You can now proceed to review your application.",
          variant: "success",
        };
      case "PAYMENT_REJECTED":
        return {
          ...
          description:
            "Your payment could not be verified. Please check your payment reference and submit a new one.",
          variant: "error",
        };
      case "APPLICATION_REJECTED":
        return {
          ...
          description:
            "Your application has been rejected by admins. Please review and correct the issues.",
          variant: "error",
        };
      case "SUBMITTED":
        return {
          ...
          description:
            "Your application has been successfully submitted to the DV system.",
          variant: "success",
        };
      default:
        return {
          ...
          description:
            "Your payment reference has been submitted and is pending admin verification. This usually takes 1-2 business days.",
          variant: "warning",
        };
    }
  }
  ...
  static validatePaymentReference(reference: string): {
    ...
    if (!/^[A-Z0-9]+$/.test(reference)) {
      errors.push(
        "Payment reference must contain only uppercase letters and numbers"
      );
    }
