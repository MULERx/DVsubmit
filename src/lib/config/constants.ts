...
export const FORM_CONFIG = {
  steps: [
    ...
    { id: 'contact', title: 'Contact Information', description: 'Address and contact details' },
    { id: 'education', title: 'Education & Work', description: 'Education and occupation details' },
    { id: 'photo', title: 'Photo Upload', description: 'Upload your DV lottery photo' },
    { id: 'payment', title: 'Payment', description: 'Pay service fee via Telebirr' },
