...
async function fetchApplicants(params: ApplicantsParams = {}): Promise<ApplicantsResponse['data']> {
  ...
  const response = await fetch(`/api/admin/applicants?${searchParams.toString()}`)
